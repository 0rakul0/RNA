"""
deep learn de rede neurais recorrente, para a tarefa solicitaad
criação de exibição grafica
"""
...
# chamar os dados
base = pd.read_csv('../data/bolsa/petr4_treinamento_ex.csv')
base_teste = pd.read_csv('../data/bolsa/petr4_teste_ex.csv')
...
for i in range(90, 1342): # vamos começar do 90 para baixo
...
for j in range(90, 110):
    X_teste.append(entradas[j-90:j, 0])
